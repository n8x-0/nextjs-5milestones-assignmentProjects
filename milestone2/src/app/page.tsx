  ...
  return (
    <>
      <div className="sm:p-12 p-4">
        <h1 className="sm:text-5xl text-4xl sm:text-left text-center font-bold sm:leading-[3rem] leading-9 text-blue-950 font-[geist] sm:mt-0 mt-5">
          Hey there,<br />
          This is <span className="text-blue-500">Syed Shayan,</span><br />
          A Full stack Web Developer.
        </h1>
        <p className="md:w-1/2 w-full mt-6 sm:text-left text-center">
      ...
      <div className="absolute bottom-0 w-full">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#3b82f6" fill-opacity="1" d="M0,224L60,234.7C120,245,240,267,360,229.3C480,192,600,96,720,80C840,64,960,128,1080,133.3C1200,139,1320,85,1380,58.7L1440,32L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path></svg>
      </div>
    </>
  );
}