...
export default function Home() {
  ...
  return (
    <div className="bg-[#2C0E5E] w-full min-h-screen pt-20">
      <div className='md:pt-40 md:pl-32 p-4 md:text-left text-center md:mt-0 mt-20'>
        ...
        <div className='w-1/2 overflow-hidden absolute bottom-0 right-0 opacity-50 scaleAnim'>
          <Image src="/purp.png" alt="" width={1280} height={1280} className='w-full h-full object-cover' />
